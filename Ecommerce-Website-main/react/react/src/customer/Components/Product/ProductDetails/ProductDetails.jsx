// HomeSectionCard.jsx = HomeProductCard.jsx
...
export default function ProductDetails() {
  ...
  const similarProducts = customersProduct?.productListByCategory.filter(
        ...
        <section className="">
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              <Grid item xs={7}>
                {/* space-y bcz used in it multiple carts */}
                <div className="space-y-5">
                  {customersProduct.product?.reviews.map((item, i) => (
                    // call the ProductReviewCard
